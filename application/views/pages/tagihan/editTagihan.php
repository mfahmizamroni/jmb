                        ...
                        <table id="example1" class="table table-bordered" style="border-width: 2px">
                          ...
                          <tr id="item<?= $i; ?>">
                            ...
                            <td>
                              ...
                              <a href="#" data-href="<?php echo base_url().'daftarmuat/deletefaktursj/'.$faktursjs->id_faktur?>" class="btn btn-default btn-xs" data-toggle="modal" data-target="#confirm-delete"><i class="fa fa-trash-o"></i></a>
                            </td>
                          </tr>
                          <?php $i++; } ?>
                        </table>                    
